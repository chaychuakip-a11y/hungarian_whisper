#!/usr/bin/env python3
"""
Hungarian Whisper Training - Fixed for ROCm 5.7
Uses transformers 4.36.0 + peft 0.7.1 on rocm57_test environment
"""
...
def main():
    logger.info("=" * 60)
    logger.info("Hungarian Whisper Training (ROCm 5.7)")
    logger.info("=" * 60)
    logger.info(f"Start time: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    logger.info(f"PyTorch: {torch.__version__}")
    logger.info(f"ROCm: {torch.version.hip}")
    ...
    logger.info("\n[4] Saving model...")
    output_dir = "./output/checkpoints_rocm57"
